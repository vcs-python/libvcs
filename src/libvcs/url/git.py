...
AWS_CODE_COMMIT_DEFAULT_RULES: list[Rule] = [
    ...
    Rule(
        label="aws-code-commit-file-url",
...
@dataclasses.dataclass(repr=False)
class GitAWSCodeCommitURL(GitBaseURL, URLProtocol, SkipDefaultFieldsReprMixin):
    ...
    def to_url(self) -> str:
        ...
        >>> git_url
        GitAWSCodeCommitURL(url=git+ssh://git@bitbucket.example.com:7999/PROJ/repo.git,
                scheme=git+ssh,
                user=git,
        ...
        >>> git_url
        GitAWSCodeCommitURL(url=git+https://github.com/vcs-python/libvcs.git@v0.10.0,
                scheme=git+https,
                hostname=github.com,
                path=vcs-python/libvcs,
                suffix=.git,
    ...
    def is_valid(cls, url: str, is_explicit: Optional[bool] = None) -> bool:
        ...
        >>> GitAWSCodeCommitURL.is_valid(url='git+https://github.com/vcs-python/libvcs.git')
        True

        >>> GitAWSCodeCommitURL.is_valid(url='git+ssh://git@github.com:vcs-python/libvcs.git')
        True
...
@dataclasses.dataclass(repr=False)
class GitURL(
    GitAWSCodeCommitURL, GitPipURL, GitBaseURL, URLProtocol, SkipDefaultFieldsReprMixin
):
